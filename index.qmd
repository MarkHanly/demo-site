...
Great, let's get started with some data analysis! In order to explore the relationship between birthweight and other factors we are going to need some data. Luckily, the R ecosystem is chockablock with example datasets. For this example, we will use the `birthwt` dataset. This dataset includes ten variables collected on 189 mother-baby dyads. The data were originally collected at Baystate Medical Center, Springfield, Massachusetts during 1986.
...
Learn how to extract actionable insights from health data in the course [HDAT9200 Statistical Foundations for Health Data Science](https://hds-hub.cbdrh.med.unsw.edu.au/courses.html#hdat9200).
:::
...
Learn how to tell compelling visual stories with data in the course [HDAT9800 Visualisation & Communication](https://hds-hub.cbdrh.med.unsw.edu.au/courses.html#hdat9800).
:::
...
Learn how to tell model realistically complex health data in the course [HDAT9700 Statistical Modelling II](https://hds-hub.cbdrh.med.unsw.edu.au/courses.html#hdat9700).
:::
